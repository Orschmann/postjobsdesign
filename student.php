...
<div class="col-md-8 main"><h2>Meet Student: <?php echo $student->name ?></h2><img src="assets/img/pbhs.jpg" class="pbhs" alt="pbhs" height="100" width="100">
  <?php
      echo '<p class="first">
            Name: ' . $student->name . '
            <br>
      ...
      echo  'Looking for: ';
            foreach ($student->occupation as $occ) {
                          echo $occ . '<br>';
                    }
      echo  'Location Near: ' . $student->location . '
            </p>'
  ?>
...
<h3>Top Reasons to Hire Me</h3><p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis partu
rient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec ped
e justo, fringilla vel, aliquet nec, vulputate eget, arcu. </p></div><!-- end col 8 -->
<div class="col-md-4 aside"><h3><?php echo $student->name ?>'s Portfolio</h3><p>http://student.santarosa.edu/~aweston/efolio/portfolio.html</p>
